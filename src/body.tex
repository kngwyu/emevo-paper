...
\begin{align}
  ...
  \label{eq:h}
\end{align}
The first term increases as energy levels decrease and follows a sigmoidal curve, where $\kappa_{h}$ is the maximum death rate and $\theta_h$ is of increased death.
