...
We implement this framework using JAX\citep{jax2018github} to accelerate simulation by utilizing GPU. Our simulation results show that the evolution of food reward is surprisingly unstable due to space and food resource constraints.
...
The first term increases as energy levels decrease and follows a sigmoidal curve, where $\kappa_{h}$ is the maximum death rate and $\theta_h$ is the energy threshold of increased death. %$\alpha_{he}$ are hyperparameters. 
...
\begin{align}
 ...
 % This parameterization is redundant:
...
\begin{figure}[t]
  \begin{subfigure}[t]{7cm}
    ...
    \subcaption{A case study for decreasing food reward.}\label{subfigure:s5lh}
  \end{subfigure}
  \begin{subfigure}[t]{7cm}
    \centering
    \includegraphics[width=7cm]{seed2-lh-orange.png}
    \subcaption{A case study for decreasing food reward.}\label{subfigure:s2lh}
  \end{subfigure}
  \caption{
...
\begin{figure}[t]
  \begin{subfigure}[t]{6cm}
    ...
    \subcaption{Evolved rewards.}\label{subfigure:blcomp}
  \end{subfigure}
  \begin{subfigure}[t]{4.5cm}
    \centering
    \includegraphics[width=4.5cm]{seed5-frdecay.png}
    \subcaption{Decreasing food reward.}\label{subfigure:s4.5}
  \end{subfigure}
  \begin{subfigure}[t]{4.5cm}
    \centering
    \includegraphics[width=4.5cm]{seed2-frstable.png}
    \subcaption{Stable food reward.}\label{subfigure:s2}
  \end{subfigure}
  \caption{
