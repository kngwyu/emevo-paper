...
\paragraph{Birth and death model}
...
\end{align}
In \cref{eq:b}, $\kappa_{b}$ is the scaling parameter for birth function, $\alpha_{e}$ is the inverse initial value of the birth function, and $d_{b}$ is the delay parameters that work as thresholds for $e$. $\kappa_{h}$ is the scaling parameter for hazard function, $\alpha_{he}$ is the inverse initial hazard that determines the behavior when $e$ is enough small,
