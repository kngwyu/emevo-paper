...
% This eat-driven emergence is not consistent with the growth equation below...
...
\begin{figure}[t]
  ...
  \begin{subfigure}[t]{6.4cm}
    \centering
    \includegraphics[width=6.4cm]{seed5-corr.png}
    \subcaption{A case study for decreasing food reward.}\label{subfigure:s5corr}
  \end{subfigure}
  \caption{
...
To investigate the reason why the evolution of food reward can be unstable, we closely look at our simulation run with seed $5$, where food reward decreases. \Cref{subfigure:s5corr} shows
