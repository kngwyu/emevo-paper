...
\Cref{figure:result-poor} shows the results with poor foods. While rewards for normal foods are positive in all five runs, the evolution of rewards for poor foods are unstable.
